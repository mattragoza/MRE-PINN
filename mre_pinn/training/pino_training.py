...
class PINOModel(deepxde.Model):
    ...
    def test(self):
        ...
        u_pred, lu_pred, mu_pred, f_trac, f_body = self.predict(*inputs)
        ...
        pde = xr.concat([f_trac * m_mask, f_body * m_mask, (f_trac + f_body) * m_mask], dim=pde_dim)
        pde.name = 'PDE'
